...
//# 5. 삼항(조건) 연산자
// : 유일하게 피연산자를 세 개르 가지는 조건 연산자 (기호가 2개)

//? 기본 구조
// 표현식 ?  반환값1 : 반환값2

// - 표션식: true 또는 false 값을 반환하는 식
// - 반환값1: 위의 표현식 조건이 참(true)일 때 반활될 값
// - 반환값2: 위의 표현식 조건이 거짓(false)일 때 반활될 값
...
let firstName = 'Junhyeok';
let lastName = 'Choi';

console.log(firstName + ' ' + lastName); // Junhyeok Choi
...
console.log(typeof functionData); // funtion