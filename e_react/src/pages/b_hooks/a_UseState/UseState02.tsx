...
// 배열은 스프레드 연산자 중복 사용시 중복된 내용이 추가
const example = [...fruits];

// 객체는 스프레드 연산자 중복 사용시 중복된 내요잉 업데이트됨
const person = {
  name: "이승아",
  age: 50,
  hobby: "자전거",
...
const person3 = { ...person, person1 }; // person, person1 이 달라도 속성이 같으면 업데이트 된다
...
book.title = "hello"; // 리액트에서 푸쉬 상태 변화 감지 X
//! >> setBook({...book, title: 'hello'});
//!    : 상태 설정 함수를 사용 + 새로운 참조값에 데이터를 담아 전달
// let result = {...book, title: 'hello'};
...
export default function UseState02() {
  ...
  return (
    <div>
      ...
      {/*
      input의 택스트를 p 태그의 내용으로 전달하는 이벤트 설정
